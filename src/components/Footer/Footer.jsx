              ...
              <div>
                <a href="/">
                  <div className="flex items-center space-x-2 text-2xl font-medium">
                    ...
                    <span className="text-white">Uplift Orbit</span>
                  </div>
                </a>
              </div>
              <div className="max-w-md pr-16 text-md text-gray-200">
              Uplift Orbit connects freelancers with top clients and projects, empowering your career to reach new heights.
              </div>
